...
structure WeakChevalleyB3Small (Φ : Type TΦ) [PosRootSys Φ] (R : Type TR) [Ring R] where
  mk ::
  -- autogenerated
...
namespace WeakChevalleyB3Small

open Steinberg

open WeakChevalleyB3Small

/-! ### Sets of relations -/
def trivial_comm_rels (w : WeakChevalleyB3Small Φ R) :=
  ⋃₀ (rels_of_trivial_commutator_of_root_pair R '' w.trivial_comm_root_pairs)

def single_comm_rels (w : WeakChevalleyB3Small Φ R) :=
  ⋃₀ (rels_of_single_commutator_of_root_pair '' w.single_comm_root_pairs)

def mixed_commutes_rels (w : WeakChevalleyB3Small Φ R) :=
...
abbrev group (w : WeakChevalleyB3Small Φ R) :=
  PresentedGroup (WeakChevalleyB3Small.all_rels w)

def pres_mk (w : WeakChevalleyB3Small Φ R) : FreeGroupOnGradedGens Φ R →* group w :=
  PresentedGroup.mk (WeakChevalleyB3Small.all_rels w)

/-! ### Helpers -/

theorem trivial_commutator_helper {w : WeakChevalleyB3Small Φ R} {ζ η : Φ}
...
theorem single_commutator_helper (w : WeakChevalleyB3Small Φ R) (ζ η θ : Φ) (C : R)
...
theorem lin_helper (w : WeakChevalleyB3Small Φ R) {ζ : Φ} (h : ζ ∈ w.lin_roots)
...
theorem nonhomog_helper (w : WeakChevalleyB3Small Φ R)
...
theorem def_helper (w : WeakChevalleyB3Small Φ R)
