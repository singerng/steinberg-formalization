...
private theorem decompose_5_into_booleans_1_2_2_helper :
  Finset.image (fun ⟨i, j, k⟩ => i + 2 * j + 2 * k) boolean_cube = Finset.range 6 := by decide

theorem decompose_5_into_booleans_1_2_2 (i : ℕ) (hi : i ≤ 5)
